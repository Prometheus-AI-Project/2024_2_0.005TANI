...
import { useNavigate, useLocation } from 'react-router-dom';import STRIKE from '../../assets/img/background/STRIKE.png'; // OUT 이미지 import
...
function StrikePage() {
  ...
  return (
    <div className="out-page">
      ...
      <img src={STRIKE} alt="OUT text" className="out-text" />
    </div>
  );
}
